...
export default function ContactPage() {
  ...
  const socialLinks = [
    ...
    { name: 'Globe', icon: 'twitter', url: 'https://twitter.com' },
          ...
          <div>
            ...
            <div className="flex space-x-6">
              {socialLinks.map((link, index) => (
                <a key={index} href={link.url} target="_blank" rel="noopener noreferrer" className="text-on-surface hover:text-ember transition-colors">
