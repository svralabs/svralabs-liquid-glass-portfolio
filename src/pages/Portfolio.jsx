          ...
          <div className="liquid-glass rounded-[1.75rem] p-6 lg:col-start-4 lg:row-start-2">
            <div className="glass-content">
              <div className="flex items-center gap-2">
                <span className="material-symbols-outlined text-white/70">terminal</span>
            ...
            <div className="glass-content">
              <div className="flex items-center justify-between">
                ...
                <div className="flex gap-2">
                  <button
                    className={`rounded-full px-3 py-1 text-sm ${filter === 'all' ? 'text-white' : 'text-white/50'} transition-colors hover:text-white`}
                    onClick={() => setFilter('all')}
                  >
                    All
                  </button>
                  <button
                    className={`rounded-full px-3 py-1 text-sm ${filter === 'design' ? 'text-white' : 'text-white/50'} transition-colors hover:text-white`}
                    onClick={() => setFilter('design')}
                  >
                    Design
                  </button>
                  <button
                    className={`rounded-full px-3 py-1 text-sm ${filter === 'dev' ? 'text-white' : 'text-white/50'} transition-colors hover:text-white`}
