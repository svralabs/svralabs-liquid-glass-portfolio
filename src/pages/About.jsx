...
import DevosTable from '../components/DevosTable';
          ...
          <div className="flex items-center gap-3">
            <div className="liquid-glass hidden items-center gap-1 rounded-full px-2 py-1.5 sm:flex">
              <span className="glass-content flex items-center gap-1">
                <Link to="/" className="rounded-full px-3 py-1 text-sm text-white/70 transition-colors hover:text-white">Home</Link>
                <Link to="/services" className="rounded-full px-3 py-1 text-sm text-white/70 transition-colors hover:text-white">Services</Link>
                <Link to="/work" className="rounded-full px-3 py-1 text-sm text-white/70 transition-colors hover:text-white">Work</Link>
                <Link to="/about" className="rounded-full px-3 py-1 text-sm text-white transition-colors hover:text-white">About</Link>
              </span>
            </div>
            <Link to="/contact" className="liquid-glass-strong flex items-center gap-2 rounded-full px-4 py-2 text-sm text-white transition-transform hover:scale-105 active:scale-95">
          ...
          <div className="liquid-glass-strong rounded-[2rem] p-8 lg:col-span-7">
            <div className="glass-content">
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                ...
                <span className="rounded-full bg-white/10 px-2.5 py-1 font-mono text-[11px] text-white/80">Palette</span>
              </div>
            </div>
          </div>
